...
export default {
  ...
  mounted() {
    ...
    this.dropzone = new Dropzone(element, {
      ...
      dictDefaultMessage: '<i style="margin-top: 3em;display: inline-block" class="material-icons">' + this.defaultMsg + '</i><br>文件拖拽到此处实现上传',
      dictMaxFilesExceeded: '超过上传文件数量',
      dictInvalidFileType: "文件类型只能是*.csv,*.xls,*.xlsx",
