<template>
  ...
  <div class="dashboard-editor-container" v-loading="listLoading">
      ...
      <div style="float: right;width: 85%;margin-bottom: 15px">
        <div
          ...
          <el-date-picker
            ...
            style="margin-top: 5px;margin-right: 0px;margin-bottom: 20px">
          </el-date-picker>
          <!--<br>-->
          ...
          <span class="card-panel-icon-wrapper icon-message" style="margin-right: 20px">
            ...
            <!--@change="arpu_change"></el-checkbox-button>-->
              <el-button size="mini" round type="primary" @click="showretention()"><svg-icon icon-class="" class-name="card-panel-icon"/>&nbsp;前往查看具体留存</el-button>
          </span>
          <span class="card-panel-icon-wrapper icon-message" style="margin-right: 20px">
    ...
    <div v-if="panel_view" style="">
      <panel-group
        @handleSetLineChartData="handleSetLineChartData"
        style="margin-top: -20px" v-bind:statistical_data="statistical_data"/>
    </div>
...
<script>
  import PanelGroup from '@/views/table/homePage/productdata/components/PanelGroup'
  import LineChart from '@/views/table/homePage/productdata/components/LineChart'
