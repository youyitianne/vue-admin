  ...
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        <div class="card-panel-icon-wrapper icon-money">
          <svg-icon icon-class="brokenLine" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">单次使用时长</div>
        ...
        <div style="margin-top: 20px;margin-left: 50px;font-size: 14px;font-weight: bolder">
          对比单次使用时长：{{statistical_data.contrast_showtimes}}<br><br>
          同比:
